...
const gameData = {
 ...
 ,
      {
        "letter": "C",
        "text": "Подойти, извиниться за неудобство, предложить пересесть на исправную карету и написать ТМ о ситуации.",
        "is_correct": true,
        "feedback_art": "🤝😤",
        "feedback_title": "Ситуацию удалось погасить",
        "feedback_text": "Отец всё ещё недоволен, но видит что ты не прячешься. Семья пересела, дети успокоились. ТМ в курсе.",
 ...
 ,
  ...
  "terpila_4": {
    ...
    ,
      {
        "letter": "C",
        "text": "Объяснить спокойно: «По правилам доп. время платное. Если были технические проблемы — напишите в поддержку, они разберутся.»",
        "is_correct": true,
        "feedback_art": "📋✅",
        "feedback_title": "По правилам — значит по правилам",
        "feedback_text": "Гость недоволен, но аргументов нет. Ты не забрал его деньги и не потерял свои. Именно так это работает.",
 ...
 ,
      {
        "letter": "C",
        "text": "Быстро найти аптечку (она у стойки), принести, помочь обработать ранку. Коротко извиниться.",
        "is_correct": true,
        "feedback_art": "🩹💚",
  ...
  "terpila_6": {
    ...
    ,
      {
        "letter": "C",
        "text": "Быстро найти аптечку у стойки, принести, помочь обработать ранку. Коротко извиниться.",
        "is_correct": true,
        "feedback_art": "🩹💚",
        "feedback_title": "Всё под контролем",
        "feedback_text": "Мама видит — ты знаешь где что лежит и не паникуешь. Ребёнок успокоился. Инцидент закрыт.",
 ...
 ,
      {
        "letter": "C",
        "text": "«Система дала сбой, сейчас решим. Одной компании — ближайшую свободную карету, второй — скидку от сервиса.» Написать ТМ.",
        "is_correct": true,
        "feedback_art": "🤝⚡",
        "feedback_title": "Конфликт погашен",
        "feedback_text": "Обе компании получили решение. Ты не убежал и не устроил аукцион. ТМ отметил твою реакцию.",
 ...
 ,
      {
        "letter": "C",
        "text": "Позвонить ТМ, объяснить ситуацию, попросить инструкцию. Попробовать прокатить карету назад — замок часто защёлкивается так.",
        "is_correct": true,
        "feedback_art": "🔒✅",
        "feedback_title": "Замок закрыт!",
 ...
 ,
  ...
  "chaos_6": {
    ...
    "choices": [
     ...
     "effects": { "loyalty": 25, "tech": 20, "safety": 20 }
      },
      {
        "letter": "B",
