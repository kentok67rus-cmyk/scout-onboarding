// game.js — Симулятор смены | Комикс-формат | Карета Мобилити | v2
...
const gameData = {   "prologue": {
  ...
  "good_3": {
   ...
   "good_4": {
    "art": "👦🛴📜",
    "chapter": "Сцена 4 — Инструктаж",
    "title": "Маленький гость",
    "bubble": "К тебе подбегает мальчик лет 7 — один, без родителей.\\nХочет потрогать руль и педали. Родители в 10 метрах, машут рукой.\\n\\n⚠️ Дети до 14 лет — только с взрослым.\\nБез взрослого садиться в карету нельзя.",
    "bubble_type": "event",
    "choices": [
      {
        "letter": "A",
        "text": "Присесть, объяснить ребёнку правила по-доброму. Дождаться родителей и рассказать им про аудиогид.",
        "is_correct": true,
        "feedback_art": "🤝✨",
        "feedback_title": "Мастерство общения!",
        "feedback_text": "Ребёнок доволен, родители благодарны. Ты не обидел малыша и не нарушил правила — это и есть мастерство.",
        "next_node": "good_5", 
        "effects": { "loyalty": 20, "tech": 0, "safety": 15 }
      },
      {
        "letter": "B",
        "text": "Просто отогнать: «Нельзя! Иди к маме!»",
        "is_correct": false,
        "feedback_art": "😭😡",
        "feedback_title": "Скандал на ровном месте",
        "feedback_text": "Ребёнок расплакался. Мама подошла и устроила сцену. Грубость с детьми — худшее, что может сделать скаут.",
        "next_node": "good_5", 
        "effects": { "loyalty": -25, "tech": 0, "safety": 0 }
      }
    ]
  },
  ...
  "good_5": {
    "art": "🌧️☔⛺",
    "chapter": "Сцена 5 — Непогода",
    "title": "Дождь!",
    "bubble": "Неожиданно начался ливень. Гостей нет — все разбежались.\\nКареты стоят открытые. Сиденья намокнут за 5 минут.\\n\\n💬 ТМ не отвечает на звонок.\\nТы один принимаешь решение.",
    "bubble_type": "event",
    "choices": [
      {
        "letter": "A",
        "text": "Накрыть кареты, убрать в укрытие всё что можно. Написать ТМ сообщение о ситуации.",
        "is_correct": true,
        "feedback_art": "☂️👏",
        "feedback_title": "Спасённый инвентарь!",
        "feedback_text": "Сиденья сухие. Когда дождь кончился — кареты готовы к работе. ТМ написал: «Молодец, сам разобрался.»",
        "next_node": "good_6", 
        "effects": { "loyalty": 0, "tech": 25, "safety": 10 }
      },
      {
        "letter": "B",
        "text": "Спрятаться самому. Кареты казённые — не моя проблема.",
        "is_correct": false,
        "feedback_art": "💦📉",
        "feedback_title": "Мокрые сиденья и простой",
        "feedback_text": "Все сиденья мокрые. Следующие 2 часа кареты не в работе. ТМ видит простой в статистике и звонит с вопросами.",
        "next_node": "good_6", 
        "effects": { "loyalty": -10, "tech": -25, "safety": -5 }
      }
    ]
  },
  ...
  "good_6": {
    "art": "👨‍👩‍👧‍👦🕰️🎟️",
    "chapter": "Сцена 6 — Очередь",
    "title": "Час пик",
    "bubble": "Суббота. К стойке выстроилась очередь — 4 семьи сразу.\\nВсе хотят карету прямо сейчас. Свободна только одна.\\n\\n😤 Люди нервничают, дети канючат.\\nКак не дать ситуации выйти из-под контроля?",
    "bubble_type": "event",
    "choices": [
      {
        "letter": "A",
        "text": "Выйти к очереди, объяснить время ожидания, раздать флаеры с QR-кодом. Поблагодарить за терпение.",
        "is_correct": true,
        "feedback_art": "😌🍦",
        "feedback_title": "Очередь под контролем!",
        "feedback_text": "Очередь успокоилась. Все дождались. Один папа сказал: «Спасибо что предупредил — мы сходили мороженое купить.»",
        "next_node": "good_7", 
        "effects": { "loyalty": 30, "tech": 0, "safety": 0 }
      },
      {
        "letter": "B",
        "text": "Молча стоять за стойкой и ждать пока кареты вернутся.",
        "is_correct": false,
        "feedback_art": "🏃‍♂️💨",
        "feedback_title": "Потерянные клиенты",
        "feedback_text": "Первый в очереди не выдержал и ушёл. Следующий накричал. Ты потерял троих клиентов за 15 минут.",
        "next_node": "good_7", 
